...
<body>
	<form method="post">
		<input type="hidden" name="id" value="${shipingOrder.id}" />
		<div id="menubar">
			<div id="middleMenubar">
				<div id="innerMenubar">
					<div id="navMenubar">
						<ul>
							<li id="save"><a href="#"
								onclick="formSubmit('${ctx}/freight/packinglist/doUpdateShipingOrder.action','_self');">确定</a></li>
							<li id="back"><a
		...
		<div class="textbox" id="centerTextbox">
			...
			<div class="textbox-header">
				<div class="textbox-inner-header">
					<div class="textbox-title">修改委托单信息</div>
				</div>
			</div>
			<div>
				<div>
