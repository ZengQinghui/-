			...
			<div id="middleMenubar">
				<div id="innerMenubar">
					<div id="navMenubar">
						<ul>
							<li id="save"><a href="#"
								onclick="formSubmit('${ctx}/freight/packinglist/doUpdate.action','_self');">确定</a></li>
		...
		<div class="textbox" id="centerTextbox">
			...
			<div class="textbox-header">
				<div class="textbox-inner-header">
					<div class="textbox-title">修改装箱单信息</div>
				</div>
			</div>
			<div>
				<div>
					<table class="commonTable" cellspacing="1">
						...
						<tr>
							...
							<td class="tableContent"><input type="text" name="invoiceNo"
						...
						<tr>
							...
							<td class="tableContent"><textarea name="marks"
									style="height: 120px;">${packingList.marks}</textarea></td>
