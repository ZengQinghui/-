				...
				<div>
					<table class="commonTable" cellspacing="1">
						<tr>
							...
							<td class="tableContent"><input type="text"
								name="acquiringFirm" value="才华商贸有限公司" /></td>
						</tr>
						<tr>
							...
							<td class="tableContentAuto"><input type="radio"
								name="printStyle" value="2" class="input" checked>两款 <input
								type="radio" name="printStyle" value="1" class="input">一款
							</td>
						</tr>
						<tr>
							<td class="columnTitle_mustbe">签单日期：</td>
							<td class="tableContent"><input id="d12" type="text"
								style="width: 90px;" name="signingDate"
								onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});" />
							</td>
							<td class="columnTitle_mustbe">重要程度：</td>
							<td class="tableContentAuto"><input type="radio"
								name="importNum" value="3" class="input" checked>★★★ <input
