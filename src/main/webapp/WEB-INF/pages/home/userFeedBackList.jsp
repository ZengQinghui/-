			...
			<div id="middleMenubar">
				<div id="innerMenubar">
					<div id="navMenubar">
						<ul>
						<li id="new"><a href="#"
								onclick="formSubmit('toSaveFB.action','_self');this.blur();">新增</a></li>
							<li id="view"><a href="#"
		...
		<div class="textbox" id="centerTextbox">
			<div class="textbox-header">
				<div class="textbox-inner-header">
					<div class="textbox-title">已提出反馈意见列表</div>
				</div>
			</div>
				...
				<div class="eXtremeTable">
					<table id="ec_table" class="tableRegion" width="98%">
						...
						<tbody class="tableBody">
							<c:forEach items="${userFeedBackList}" var="feedBack"
								varStatus="status">
								<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
									<td><input type="checkbox" name="feedBackId" value="${feedBack.id}" /></td>
									<td>${status.index+1}</td>
									<td><a href="${ctx}/home/toViewFB.action?feedBackId=${feedBack.id}"><fmt:formatDate value="${feedBack.inputTime}"
