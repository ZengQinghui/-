...
public class ContractVO {
	...
	public String getAcquiringFirm() {
		return acquiringFirm;
	}

	public void setAcquiringFirm(String acquiringFirm) {
		this.acquiringFirm = acquiringFirm;
	}
