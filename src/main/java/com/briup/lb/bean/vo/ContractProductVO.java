...
public class ContractProductVO {
	...
	private Contract contract;   // 和合同多对一
	private List<EnclosureVO> enclosures; // 和附件一对多
	...
	public List<EnclosureVO> getEnclosures() {
		return enclosures;
	}

	public void setEnclosures(List<EnclosureVO> enclosures) {
